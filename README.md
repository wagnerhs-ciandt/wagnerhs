...
class AboutMe:
    ...
    def __str__(self):
      return f"My name is {self.name}. I'm {self.age} years old and I work as a {self.work}"
...
<p>
    ...
    I took a lot of Python Courses: Back End with Django, DRF, Flask and FastAPI, Machine Learning and Data Science with Numpy, Scikit-Learn and Pandas, Games with PyGame and Scraping with Selenium, Requests and BeautifulSoup.</p>    
